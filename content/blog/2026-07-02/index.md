...
**现在很多官网长得越来越像同一个模板：柔和渐变、圆角卡片、玻璃拟态。**

虽然看起来精致，如果只看一张截图，很难分清是哪家产品，**更有甚者，vibe一个界面就拿出来了，丑的让人看不下去。**

而另一批 AI 工具、开发者产品和内容封面却走向另一个风格：**粗黑边框、硬投影、撞色色块、巨大的标题字。**界面充满了"不规范"的奔放风格，反而更容易被记住。
...
- **Gumroad** — [https://gumroad.com/](https://gumroad.com/) ｜厚黑边框、硬偏移阴影、扁平撞色块、超大标题，被多篇设计指南称为 neubrutalism 的「海报儿童」
- **RetroUI 官网** — [https://retroui.dev/](https://retroui.dev/) ｜NeoBrutalism React + Tailwind 组件库的官方演示站
- **Panda CSS** — [https://panda-css.com/](https://panda-css.com/) ｜开发者向构建时样式库官网，块状营销页 + 原始硬朗美学

**可直接拿来搭页面的组件库**

- **Logging-Studio/RetroUI** — [https://github.com/Logging-Studio/RetroUI](https://github.com/Logging-Studio/RetroUI) ｜1.5k star
- **ANIBIT14/boldkit** — [https://github.com/ANIBIT14/boldkit](https://github.com/ANIBIT14/boldkit)
- **ekmas/neobrutalism-components** — [https://github.com/ekmas/neobrutalism-components](https://github.com/ekmas/neobrutalism-components) ｜5.2k star

**画廊入口**

- **Webflow — Made in Webflow: Neobrutalism** — [https://webflow.com/made-in-webflow/neobrutalism](https://webflow.com/made-in-webflow/neobrutalism) ｜收录大量可直接 clone 的真实上线站点

**示例｜AI 提示词管理工具定价页｜标题「PROMPT OS」**

![Gumroad 产品市场界面，顶部搜索和分类导航，下方以商品卡片、价格标签、评分和筛选栏组成商城](https://pbs.twimg.com/media/HMMfd65W4AAEena?format=jpg&name=large)

**文生图｜复制即用：产品/工具视觉概念示意图提示词**
...
- **Panda CSS** — [https://panda-css.com/](https://panda-css.com/) ｜营销页本身就是新粗野主义
- **RetroUI 官网** — [https://retroui.dev/](https://retroui.dev/) ｜同时也是开发者视觉的例子

**可直接引用/截图的 GitHub 项目**

- **khangtrannn/ng-brutalism** — [https://github.com/khangtrannn/ng-brutalism](https://github.com/khangtrannn/ng-brutalism) ｜Angular，2026-06 更新
- **Bridgetamana/neobrutal-ui** — [https://github.com/Bridgetamana/neobrutal-ui](https://github.com/Bridgetamana/neobrutal-ui) ｜Base UI + Tailwind
- **matifandy8/NeoBrutalismCSS** — [https://github.com/matifandy8/NeoBrutalismCSS](https://github.com/matifandy8/NeoBrutalismCSS) ｜极简 CSS 框架
- **ComradeAERGO/Awesome-Neobrutalism** — [https://github.com/ComradeAERGO/Awesome-Neobrutalism](https://github.com/ComradeAERGO/Awesome-Neobrutalism) ｜精选资源索引，适合做延伸阅读入口

**示例｜开源 CLI 工具主页｜标题「TERMINAL KIT」**

![TERMINAL KIT 开源工具主页概念，以黑色终端窗口、彩色代码块、模块列表和系统状态卡展示 CLI 工具](https://pbs.twimg.com/media/HMMfi7NXMAA2TfL?format=jpg&name=large)

**文生图｜复制即用：开发者视觉概念示意图提示词**
...
[neubrutalism.com](https://neubrutalism.com/) 把它现在的状态总结成一个词：**Anti-AI Signal**——手作感、原始感的视觉，本身就是对抗 AI 同质化的信号。AI 官网越来越像同一个模板，新粗野主义好用，恰恰因为它足够「不像 AI」
...
**本篇“新粗野主义”分享完，最初起源于建筑学的“传统粗野主义”，也将在下篇展开，感谢支持。**
