---
title: "纹理平面风格人像重绘（附提示词&Skill）"
description: "把人物压缩成简洁色面，用夸张比例、克制配色与细密颗粒重绘为具有手工感的纹理平面人像，并附提示词与 Skill。"
pubDate: 2026-07-31
sourceId: "2026-07-31"
slug: textured-flat-portrait
category: prompt-sharing
tags: ["人像","插画","提示词"]
cover: "/uploads/blog/2026-07-31/HOiOwaKWYAA6bbf.jpg"
coverAlt: "蓝、橙、青与橄榄色四个竖向色块中排列四位比例夸张、带颗粒纹理的平面风格人物肖像"
titleEn: "Textured Flat Portrait Redraw: Prompt and Skill"
descriptionEn: "Reduce a portrait to simple color planes, then use exaggerated proportions, restrained palettes, and fine grain to create a tactile flat illustration."
coverAltEn: "Four exaggerated, grain-textured flat portraits appear in vertical blue, orange, teal, and olive panels"
contentStatus: full
featured: false
draft: false
externalLinks:
  - label: "x"
    url: "https://x.com/Formulasearch/status/2083072322731209003"
---
最近看到一组纹理平面风格的人像插画，很喜欢这种处理： 人物被压缩成几块简单的色面，比例有意夸张，表面又带着细密的颗粒感。

我把这种风格拆成了几个更具体的部分：形体怎么简化、比例怎么夸张、色块怎么控制、颗粒应该出现在哪里。最后整理成了一套可以直接复制的提示词，并提供Skill版本。
...
简易版复制即用提示词如下，只需要上传一张任意的人物图片，然后复制粘贴以下的提示词即可：
